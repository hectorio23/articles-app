export function Header() {
    return (
        <div className="w-full bg-gray-900 py-3 col-span-4 px-40 text-white overflow-y-auto">
            <h1 className="text-3xl p-2 font-semibold text-white">Enginnering Notes on Systems Infraestructure, and Software Reality.</h1>
            <p className="text-lg pl-2 text-gray-300">Long-form technical analisys and commentary. No hype. No shortcuts.</p>
            <ul className="mt-6 w-7xl m-auto">
                ...
                <ul className="inline-block bg-gray-800 border border-gray-700 rounded text-center align-middle p-1 float-end">
